...
const PendapatanCharts = ({
  ...
  useEffect(() => {
    if (showMonthly) {
      getChartOnYearAction("income", year);
    } else {
      getChartByYearAction("income", rangeYear.from, rangeYear.to);
    }
  }, [showMonthly, year]);
            ...
            <CardTitle className="d-flex align-items-center justify-content-between">
              ...
              {!showMonthly && (
                <div className="w-30 d-flex">
                  ...
                  <Button
                    ...
                    onClick={() => getChartByYearAction("income", rangeYear.from, rangeYear.to)}
                  >
                  </Button>
                </div>
              )}
              <UncontrolledDropdown className="dropdown-menu-right">
                <DropdownToggle color="">
                  <i className="simple-icon-options-vertical text-primary text-md" />
                </DropdownToggle>
                <DropdownMenu>
                  <NavLink
                    to={{
                  ...
                  >
                    <DropdownItem>Pengaturan target</DropdownItem>
                  </NavLink>
                </DropdownMenu>
              </UncontrolledDropdown>
            </CardTitle>
